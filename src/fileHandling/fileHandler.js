...
export default function generateDoc(data) {
    ...
    var text3 = data.text3;
    var fileName= data.fileName;

    var pObj = docx.createP ();

    pObj.addText ( text1 );
    pObj.addText ( text2, { color: '000088' } );
    pObj.addText ( text3, { color: '00ffff', back: '000088' } );
    ...
    var tableStyle = {
        ...
        //borderSize: "3", // size of border width
        //bordersInsideH:false, //do not remove horizontal borders from inside table
        //bordersInsideV:false, //do not remove vertical borders from inside table
    }
